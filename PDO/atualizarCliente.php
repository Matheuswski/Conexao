...
//Se u ID for enviado, busca o cliente no banco
if($idCliente && is_numeric($idCliente)){
    ...
    $msgErro = "Digite o ID do clientepara buscar os dados.";
}
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
        ...
        <!-- Se houver erro, exiba a mensagem e o campo de busca --></h2>
        <?php if($msgErro): ?>
        ...
        <form action="processarAtualzação.php" method="POST">
